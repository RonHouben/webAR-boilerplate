...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/jsartoolkit5/artoolkit.api.js":[function(require,module,exports) {
...
(function () {
  ...
  */
  ...
  var ARController = function ARController(width, height, camera) {
    var w = width,
        h = height;
  ...
  */
  ...
  ARController.getUserMedia = function (configuration) {
    ...
    if (configuration.width) {
      ...
      if (_typeof(configuration.width) === 'object') {
    ...
    if (configuration.height) {
      ...
      if (_typeof(configuration.height) === 'object') {
  ...
  */
  ...
  var ARCameraParam = function ARCameraParam(src, onload, onerror) {
    this.id = -1;
    this._src = '';
    this.complete = false;
    this.onload = onload;
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/jsartoolkit5/artoolkit.api.js"], null)
//# sourceMappingURL=/artoolkit.api.820d0934.js.map